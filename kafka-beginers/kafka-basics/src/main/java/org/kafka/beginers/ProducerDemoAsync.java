...
public class ProducerDemoAsync {
    private static  final Logger log= LoggerFactory.getLogger(ProducerDemoAsync.class.getSimpleName());
...
//        properties.setProperty("sasl.mechanism","PLAIN");
        ...
        ProducerRecord<String,String> producerRecord= new ProducerRecord<>("demoProducer-3","Hello from Asynch Kafka producer!!!!!!");
